...
class CommandTypeTest {
    ...
    void from_supportedCommands_correctTypes() {
        ...
        assertEquals(CommandType.DEADLINE, CommandType.from("deadline return /by 2026-08-30"));
        assertEquals(CommandType.EVENT, CommandType.from("event meeting /from 2pm /to 4pm"));
    }
